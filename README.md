...
# 1.识别效果展示
![1.png](123459c06240922227741f5dffa25eb5.png)

![2.png](f71321478c2d2697999ce48299b7f3f4.png)

![3.png](b109c4007a1c599fe8d70260bdba38a9.png)



# 2.视频演示
[[YOLOv7]基于YOLOv7的安全帽佩戴检测系统(源码＆部署教程)_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1gU4y1z7vo?spm_id_from=333.999.0.0&vd_source=bc9aec86d164b67a7004b996143742dc)
...
![5.png](838e344f84d9deec93b3662b129fb470.png)
...
[该博客团队提出了基于 ELAN 的扩展 E-ELAN](https://mbd.pub/o/bread/Y5WVl55t)，其主要架构如图所示。
![6.png](a8e55d132e2b9d3ce8afdda346d42400.png)
[该博客提出的 E-ELAN](https://afdian.net/item?plan_id=532543a05ff511ed871452540025c377) 完全没有改变原有架构的梯度传输路径，其中使用组卷积来增加添加特征的基数（cardinality），并以 shuffle 和 merge cardinality 的方式组合不同组的特征。这种操作方式可以增强不同特征图学得的特征，改进参数的使用和计算效率。
...
![7.png](a8cb24ffb486dc84d0b4cbba27226d82.png)

# 5.数据集的准备
## 标注收集到的图片制作YOLO格式数据集

![11.png](9579ff313bfcb654749545c71b6f4701.png)
自己创建一个myself.yaml文件用来配置路径，路径格式与之前的V5、V6不同，只需要配置txt路径就可以
![8.png](bf79f3f65dfefd736200ca20d6af305f.png)

![9.png](264d2a8a2326d65446043d1139dd0c6b.png)
 train-list.txt和val-list.txt文件里存放的都是图片的绝对路径（也可以放入相对路径）
![12.png](4df71f543fe91e054a3a3ed9b39d959b.png)
...
![13.png](fa44cd9d9dd2a3710b5c334665cd012b.png)

路径修改完之后右击运行即可
![14.png](bd341ff02b553561e3008ccbd04d37dc.png)
...
附上本文实验设备配置
![16.jpg](7332093f4abf9021123f8eb27692b5ae.jpeg)


# 7.测试验证
下面放上对比图：（上面V7，下面V5）
![15.png](08e7176fa562c312ff40f5714b49f606.png)


# 8.系统整合
下图[完整源码&环境部署视频教程&数据集&自定义UI界面](https://s.xiaocichang.com/s/c1d88a)
![4.png](82af44cdcdb43cfc42189db805c4c51c.png)

参考博客[《安全帽佩戴检测系统(源码＆教程)》](https://mbd.pub/o/qunma/work)
